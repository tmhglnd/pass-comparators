...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 150.0, 125.0, 159.0, 47.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 150.0, 30.0, 150.0, 87.0 ],
					"text" : ">p\n\nif inlet[0] is greater then inlet[1]/argument pass input to output, else no output"
				}
